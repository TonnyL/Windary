...
class ValidateBinarySearchTreeTests: XCTestCase {
    ...
    func testIsValidBST() {
        ...
        var node213 = ValidateBinarySearchTree.TreeNode(2)
        ...
        var node123 = ValidateBinarySearchTree.TreeNode(1)
        ...
        var node321 = ValidateBinarySearchTree.TreeNode(3)
        ...
        var node10 = ValidateBinarySearchTree.TreeNode(1)
        node10.right = ValidateBinarySearchTree.TreeNode(0)
        XCTAssertFalse(v.isValidBST(node10))
        
        var node0Minus1 = ValidateBinarySearchTree.TreeNode(0)
